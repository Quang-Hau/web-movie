...
$sql_img = "SELECT * FROM newmovie WHERE id_movie = $updateid";
...
$sqlUpdate = "UPDATE newmovie 
    SET `movie_name`='$name',`nation`='$nation',`publish`='$publish',
    `time`='$time',`performer`='$performer',`moviedetails`='$moviedetails',";

if ($uploadimg) {
  $sqlUpdate .= "`img_movie`='$imgs',";
}
...
$sqlUpdate .= " `movie_genre`='$moviegenre' WHERE `id_movie` = $updateid ";
...
<body>
  <div id="container">
    <div id="success-box">
      ...
      <button class="button-box"><a href="index-admin.php?movie=listnewmovie" class="green">continue</a></button>
    </div>
    <!-- <div id="error-box">
    <div class="dot"></div>
    <div class="dot two"></div>
