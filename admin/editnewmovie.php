...
$sql = "SELECT * FROM newmovie WHERE id_movie = $id";
...
<div class="container">
        ...
        <form action="updatenewmovie.php" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?php echo $row['id_movie'];?>">
            <div class="form_group">
                <input type="text" name="namemovie" id="namemovie" required value="<?php echo $row['movie_name']?>">
