...
<?php
    ...
    $movieSql = "SELECT * FROM single_movie,movie_nation WHERE single_movie.nation=movie_nation.nation_id AND id_singlemv ='$movieId'";
...
<div class="movie container">
    <div class="play_movie">
        ...
        <source src="<?php echo "admin/".$row['movie_url'] ?>" alt="<?php echo $row['name_singlemv']; ?>" type="video/mp4">
        </video>
    </div>
    ...
    <div class="movie_info">
            <img src="<?php echo "admin/".$row['img_singlemv'] ?>" alt="<?php echo $row['name_singlemv']; ?>"  class="poster_img">

        </div>
        <div class="movie_body">
            <div class="movie_body--heading">
                <h1><?php echo $row['name_singlemv'];?></h1>
                <div class="home-info">
            ...
            <div class="moviedetails">
                ...
                <div class="moviedetails_body">
                <span><?php echo $row['name_singlemv'];?></span> <p><?php echo $row['moviedetails'];?></p>
                </div>
            </div>
        </div>
